Sunniesnow.I18n = {
	...
	DIRECT_REPLACEMENTS: {
		'en-US': {
			...
			judgementWindowsCustomDragFlick: 'drag-flick',
			...
			glPowerPreferenceIntroducer: 'Power preference:',
			webgpuCategory: 'WebGPU options',
			gpuPowerPreferenceIntroducer: 'Power preference:',
			debugCategory: 'Debug',
		...
		'zh-CN': {
			...
			glPowerPreferenceIntroducer: '性能偏好:',
			webgpuCategory: 'WebGPU 选项',
			gpuPowerPreferenceIntroducer: '性能偏好:',
			debugCategory: '调试',
		...
		'ja-JP': {
			...
			glPowerPreferenceIntroducer: 'パワードプリファレンス:',
			webgpuCategory: undefined,
			gpuPowerPreferenceIntroducer: undefined,
			debugCategory: 'デバッグ',
	...
	LABELS: {
		'en-US': {
			...
			rendererWebgpuRadio: ' WebGPU',
			glVersion1Radio: ' 1',
			glVersion2Radio: ' 2',
			glAntialias: ' Antialias',
			glPowerPreferenceDefaultRadio: ' Default',
			glPowerPreferenceLowPowerRadio: ' Low power',
			glPowerPreferenceHighPerformanceRadio: ' High performance',
			gpuAntialias: ' Antialias',
			gpuPowerPreferenceLowPowerRadio: ' Low power',
			gpuPowerPreferenceHighPerformanceRadio: ' High performance',
		...
		'zh-CN': {
			...
			glVersion2Radio: ' 2',
			glAntialias: ' 抗锯齿',
			glPowerPreferenceDefaultRadio: ' 默认',
			glPowerPreferenceLowPowerRadio: ' 低功耗',
			glPowerPreferenceHighPerformanceRadio: ' 高性能',
			gpuAntialias: ' 抗锯齿',
			gpuPowerPreferenceLowPowerRadio: ' 低功耗',
			gpuPowerPreferenceHighPerformanceRadio: ' 高性能',
			debug: ' 启用调试模式',
		...
		'ja-JP': {
			...
			rendererWebglRadio: ' WebGL',
			rendererWebgpuRadio: ' WebGPU',
			glVersion1Radio: undefined,
			glVersion2Radio: undefined,
			glAntialias: ' アンチエイリアス',
			glPowerPreferenceDefaultRadio: ' デフォルト',
			glPowerPreferenceLowPowerRadio: ' ローパワー',
			glPowerPreferenceHighPerformanceRadio: ' ハイパフォーマンス',
			gpuAntialias: undefined,
			gpuPowerPreferenceLowPowerRadio: undefined,
			gpuPowerPreferenceHighPerformanceRadio: undefined,
			debug: ' デバックゲームを有効にする',
