		...
		if (Sunniesnow.Utils.isBrowser()) {
			...
			if (Sunniesnow.game.settings.audioTime == 'worklet-processor') {
				if (crossOriginIsolated) {
					// FrameReporter.js and TimeReporter.js cannot be part of the main bundle
					// because they are loaded as an audio worklet and a worker respectively.
					const reporterDirectory = Sunniesnow.Utils.pathJoin(Sunniesnow.Utils.base(), 'audio');
