...
##### Upload {#level-file-upload}

- **Setting id**: `level-file-upload`.
- **Notice**: This setting **cannot** be specified through [URL parameters](#url-search-parameters).
...
#### Judgement time windows {#judgement-windows}
...
<a href="https://lyricagame.wixsite.com/lyricagame" target="_blank">Lyrica</a>.
...
##### Minimum distance {#min-flick-distance}
...
##### Maximum distance {#max-flick-distance}
...
##### Judgement priority by angle {#overlapping-flick-fix}
...
##### Area for keeping {#hold-keep-size}
...
##### Area for switching finger by tapping {#hold-switch-tap-size}
...
##### Area for switching finger by swiping {#hold-switch-swipe-size}
...
##### Area for screening tapping {#hold-screening-size}
...
##### Release leniency {#hold-release-leniency}
...
##### Drag notes cannot be hit early {#no-early-drag}
...
##### Shrinking speed of circles {#speed}
...
##### Speed of incoming tip points {#tip-point-speed}
...
##### Distance of incoming tip points {#tip-point-distance}
...
##### Drag-flick {#note-size-drag-flick}
...
##### Head-only hold {#note-size-head-only-hold}
...
##### From level {#background-from-level}
...
- **Note**: This setting **cannot** be specified in [URL parameters](#url-search-parameters).
...
#### FX (note hit special effects) {#fx}
...
#### Skin (note style and other UI) {#skin}
...
##### Drag-flick {#double-line-drag-flick}
...
##### Head-only hold {#double-line-head-only-hold}
...
##### Override chart settings {#force-double-line}
...
##### Hide FX in front of notes {#hide-fx-in-front}
...
##### Hide FX of perfect judgement {#hide-fx-perfect}
...
##### Hide FX of start of hold notes {#hide-fx-hold-start}
...
##### Hide FX of start of head-only hold notes {#hide-fx-head-only-hold-start}
...
##### Always update FX even when pausing {#always-update-fx}
...
##### Judgement line position {#scroll-judgement-line}
...
##### Background notes {#hide-bg-notes}
...
##### Background pattern {#hide-bg-pattern}
...
##### Reverse the display order of notes {#reverse-note-order}
...
##### Circles move with notes {#circle-moves-with-note}
...
##### Disable ornamental effects {#disable-ornament}
...
This setting is only **useful** when [`se`](#se-note-hit-sound-effects) is set to `"online"`.
...
This setting is only **useful** when [`se`](#se-note-hit-sound-effects) is set to `"upload"`.
...
#### Play SE with music {#se-with-music}
...
See <a href="https://developer.mozilla.org/en-US/docs/Web/API/AudioContext/AudioContext#latencyhint" target="_blank">here</a>
for the meaning of each options.

##### Value {#latency-hint-value}
...
##### Tap pause button twice in {#pause-double-time}
...
##### Notes have priority over the pause button {#notes-priority-over-pause}
...
##### Automatically pause when toggling fullscreen {#pause-fullscreen}
...
##### Automatically pause when losing focus {#pause-blur}
...
##### Hide pause UI by default {#hide-pause-ui}
...
##### Pause when the level is about to finish {#pause-finish}
...
##### Function of the pause button while pausing {#second-pause}
...
(reminding you of <a href="https://osu.ppy.sh" target="_blank">osu!</a>),
...
##### Keyboard keys have whole-screen judgement {#keyboard-whole-screen}
...
<a href="https://developer.mozilla.org/en-US/docs/Web/API/UI_Events/Keyboard_event_key_values" target="_blank">here</a>
...
or [`keyboard-pause`](#keyboard-can-press-pause-button-in-game) is `false`.
This applies to all scenes including the main gameplay scene, the pause menu, and the results scene.
...
##### Enable mouse buttons {#enable-mouse}
...
##### Mouse buttons have whole-screen judgement {#mouse-whole-screen}
...
##### Exclude mouse buttons {#exclude-buttons}
...
<a href="https://developer.mozilla.org/en-US/docs/Web/API/MouseEvent/button#value" target="_blank">here</a>.
...
##### Pause mouse buttons {#pause-buttons}
...
##### Mouse can click pause button in-game {#mouse-pause}
...
##### Touchscreen has whole-screen judgement {#touchscreen-whole-screen}
...
##### Can touch pause button in-game {#touch-pause}
...
##### Enable sscharter integration {#sscharter}
...
##### Live restart {#sscharter-live-restart}
...
##### Enable Discord Rich Presence {#discord-presence}
...
##### Use "Watching" instead of "Playing" {#watching-instead-of-playing}
...
##### Enter fullscreen on start {#fullscreen-on-start}
...
##### Float instead of actual fullscreen {#float-as-fullscreen}
...
##### Avoid downloading fonts {#avoid-downloading-fonts}
...
##### Enable when playing {#context-menu-play}
...
##### Enable when pausing or finished {#context-menu-pause}
...
##### Disable when holding <kbd>Control</kbd> or <kbd>Alt</kbd> {#context-menu-no-modifier}
...
Sunniesnow uses the <a href="https://webgl.org" target="_blank">WebGL</a> API
to draw everything.
...
##### Power preference {#gl-power-preference}
...
##### Hide debug UI except in pause {#hide-debug-except-pause}
...
#### Delete saved settings {#delete-settings}
...
#### Export saved settings {#export-settings}

You can export the saved settings to a JSON file here.

#### Import saved settings {#import-settings}

You can import saved settings from a JSON file here.

### Offsets

#### Delete saved chart offsets {#delete-chart-offsets}
...
#### Delete caches of online resources {#delete-online-caches}
...
#### Delete caches of site resources {#delete-site-caches}
...
#### Delete caches of external resources {#delete-external-caches}
...
#### Toggle pause UI {#game-toggle-pause-ui}
...
You can utilize the
<a href="https://sunniesnow.github.io/game/?level-file=online&amp;level-file-online=offset-wizard" target="_blank">Offset Wizard</a>,
...
You can just add the $\mu$ value of one of your plays of the chart
...
<a href="https://en.wikipedia.org/wiki/URL_encoding" target="_blank">URL-encoded</a>
